...
public class ProfileController {
	...
	public ResponseEntity<Response> addProfile(@RequestBody MultipartFile file, String fileName, String contentType,
			@RequestHeader("token") String token) {
		ProfilePic add = service.uploadFileTos3Bucket(file, fileName, contentType, token);
